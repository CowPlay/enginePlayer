...
//
		class CNullDriver: public IVideoDriver //, public IGPUProgrammingServices
		{
			public:
				...
				//! Default constructor
				CNullDriver(IEnginePlayer* player);
			...
			protected:
				...
				void drawVertexPrimitiveList(
						...
						EVertexType vType=EVT_STANDARD, scene::EPrimitiveType pType=scene::EPT_TRIANGLES,
						EIndexType iType=EIT_16BIT);

				//! Draws vertext primitive list for 2D mode
				void draw2DVertexPrimitiveList(const void* vertices, u32 vertexCount, const void* indexList, u32 primitiveCount, EVertexType vType, scene::EPrimitiveType pType, EIndexType iType);
...
//		virtual void draw3DBox(const aabbox3df& box,
//			SColor color = SColor(255,255,255,255));
//
