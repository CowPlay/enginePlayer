...
//			glDisable(GL_ALPHA_TEST);
				...
				E_BLEND_FACTOR factor) const
		{
			...
			switch (factor)
			{
				...
				case EBF_DST_COLOR:
				{
					result = 0x0306;//GL_DST_COLOR;
					break;
				}
				case EBF_ONE_MINUS_DST_COLOR:
				{
					result = 0x0307;//GL_ONE_MINUS_DST_COLOR;
					break;
				}
				case EBF_SRC_COLOR:
				{
					result = 0x0300;//GL_SRC_COLOR;
					break;
				}
				case EBF_ONE_MINUS_SRC_COLOR:
				{
					result = 0x0301;//GL_ONE_MINUS_SRC_COLOR;
					break;
				}
				case EBF_SRC_ALPHA:
				{
					result = 0x0302;//GL_SRC_ALPHA;
					break;
				}
				case EBF_ONE_MINUS_SRC_ALPHA:
				{
					result = 0x0303;//GL_ONE_MINUS_SRC_ALPHA;
					break;
				}
				case EBF_DST_ALPHA:
				{
					result = 0x0304;//GL_DST_ALPHA;
					break;
				}
				case EBF_ONE_MINUS_DST_ALPHA:
				{
					result = 0x0305;//GL_ONE_MINUS_DST_ALPHA;
					break;
				}
				case EBF_SRC_ALPHA_SATURATE:
				{
					result = 0x0308;//GL_SRC_ALPHA_SATURATE;
					break;
				}
				default:
				{
